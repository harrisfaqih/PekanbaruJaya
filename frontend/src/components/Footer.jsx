        ...
        <div className="w-3/12 lg:w-4/12 sm:w-full">
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2 text-slate-600">
              <li>Address : jl.Barau-barau, villa fajar indah 2 blok A.8</li>
              <li>Phone : 081268895949</li>
              <li>Email : qifahsirrah@gmail.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="w-4/12 lg:w-full lg:mt-6">
          <div className="w-full flex flex-col justify-start gap-5">
            ...
            <div className="h-[50px] w-full bg-white border relative">
              ...
              />
              <button className="h-full absolute right-0 bg-blue-500 text-white uppercase px-4 font-bold text-sm">
                Subscribe
              </button>
            </div>
            <ul className="flex justify-start items-center gap-3">
              <li>
                <a
                  className="w-[38px] h-[38px] hover:bg-blue-300 hover:text-white flex justify-center items-center bg-white rounded-full"
                  href="#"
                >
                  <FaFacebookF />{" "}
                </a>
