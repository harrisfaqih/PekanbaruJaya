                      ...
                      <form onSubmit={save}>
                        <div className="flex md:flex-col md:gap-2 w-full gap-5 text-slate-600">
                          <div className="flex flex-col gap-1 mb-2 w-full">
                            ...
                            <input
                              ...
                              value={state.name}
                              type="text"
                              className="w-full px-3 py-2 border border-slate-200 outline-none focus:border-blue-500 rounded-md"
                              name="name"
                              id="name"
                              placeholder="Name"
                            />
                        ...
                        <div className="flex md:flex-col md:gap-2 w-full gap-5 text-slate-600">
                          ...
                          <div className="flex flex-col gap-1 mt-7 mb-2 w-full">
                            <button className="px-3 py-[6px] rounded-sm hover:shadow-blue-500/50 hover:shadow-lg bg-blue-500 text-white">
                              Save Change{" "}
                            </button>
                          </div>
                        </div>
                      ...
                      <div className="w-full flex flex-wrap">
                        <div className="flex sm:w-full gap-2 w-7/12">
                          <div className="flex gap-2 justify-start items-center">
                            ...
                            <div className="pr-4 text-slate-600">
                              ...
                              <span className="text-sm">Brand: Maskara</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                          <div className="pl-4 sm:pl-0">
                            <h2 className="text-lg text-orange-500">Rp240</h2>
            ...
            <div className="w-[33%] md-lg:w-full">
              <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span>Total </span>
                    <span className="text-lg text-[#059473]">Rp490 </span>
                  </div>
                  <button
