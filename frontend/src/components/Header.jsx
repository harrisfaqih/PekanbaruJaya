    ...
    <div className="w-full bg-white">
          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8 font-semibold text-black">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                ...
                <span>qifahsirrah@gmail.com</span>
              </li>
              <li className="flex relative justify-center items-center gap-2 text-sm ">
                <span>
                  <IoMdPhonePortrait />
                </span>
                <span>+(68) 812 6889 5949</span>
              </li>
            </ul>
          ...
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className="md-lg:w-full w-3/12 md-lg:pt-4">
              <div className="flex justify-between items-center">
                <Link to="/">
                  <img
                    src="http://localhost:3000/images/LogPBJ.png"
                    alt=""
                    style={{
                      width: "300px",
                      height: "70px",
      ...
      <div className="w-[85%] lg:w-[90%] mx-auto">
        <div className="flex w-full flex-wrap md-lg:gap-8">
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] bg-blue-700 text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer mt-10"
              >
              ...
              <div
                ...
                } overflow-hidden transition-all md-lg:relative duration-500 absolute z-[99999] bg-blue-300 w-full border-x`}
              >
          ...
          <div className="w-9/12 pl-8 md-lg:pl-0 md-lg:w-full mt-10">
