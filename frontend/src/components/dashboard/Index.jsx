...
const Index = () => {
  ...
  }, [dispatch, userInfo.id]); // Menambahkan 'dispatch' dan 'userInfo.id' sebagai dependencies
                  ...
                  <tr className="bg-white border-b">
                    ...
                    >
                      ...
                      {o.payment_status !== "paid" && (
                        <span
                          onClick={() => redirect(o)}
                          className="bg-blue-200 text-blue-800 text-md font-semibold mr-2 px-3 py-[2px] rounded cursor-pointer"
                        >
                          Pay Now
                        </span>
                      )}
