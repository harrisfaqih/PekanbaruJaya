...
const Reviews = () => {
  ...
  return (
    <div className="mt-8">
      ...
      <h2 className="text-slate-600 text-xl font-bold py-5">Product Review</h2>
      <div div className="flex flex-col gap-8 pb-10 pt-4">
        {[1, 2, 3, 4, 5].map((r, i) => (
          <div key={i} className="flex flex-col gap-1">
            ...
            <span className="text-slate-600 text-md">harris faqih</span>
